...
export const featuresSectionData = {
    en: {
        ...
        description: 'CreateUGC on paras AI UGC -videogeneraattori luojille, brändeille ja markkinoijille. Tuota helposti korkeasti konvertoivia UGC-mainosvideoita tekoälyllä – ei näyttelijöitä, ei editointia, ei viivästyksiä.'
    }
};
...
export const footerData = {
    en: {
        slogan: 'Ready to transform your content? Join thousands of brands creating viral UGC with AI. No credit card required. Start creating now.',
        ...
        slogan: 'Valmis muuttamaan sisältösi? Liity tuhansien brändien joukkoon, jotka luovat viraalia UGC:tä tekoälyllä. Ei luottokorttia. Aloita nyt.',
...
export const ctaData = {
    en: {
        ...
        description: 'Liity tuhansien brändien joukkoon, jotka luovat viraalia UGC:tä tekoälyllä. Ei luottokorttia. Aloita nyt.',
...
export const useCasesData = [
    {
        ...
        text: {
            en: { title: 'Ecom Store Owners', desc: 'Turn your product page into a ready-to-run video ad for TikTok, Meta & more - no filming, no editing, just sales.' },
            fi: { title: 'Verkkokauppiaat', desc: 'Muuta tuotesivusi valmiiksi videomainokseksi TikTokkiin, Metaan ja muualle – ei kuvausta, ei editointia, vain myyntiä.' }
        }
    },
    {
        icon: <ShoppingCartIcon className="size-5 text-violet-300" />,
        text: {
            en: { title: 'Dropshippers', desc: 'Ditch Upwork delays. Paste your product link and create viral-style UGC in 60 seconds - launch same day.' },
            fi: { title: 'Dropshippaajat', desc: 'Unohda Upwork-viiveet. Liitä tuotelinkkisi ja luo viraalityylinen UGC 60 sekunnissa – julkaise saman päivän aikana.' }
        }
    },
    {
        icon: <InstagramIcon className="size-5 text-violet-300" />,
        text: {
            en: { title: 'DTC Brands', desc: 'Test dozens of creatives fast. Launch avatar-led UGC videos tailored to your niche - and your metrics.' },
            fi: { title: 'DTC-brändit', desc: 'Testaa kymmeniä luovia ratkaisuja nopeasti. Julkaise avatar-vetoisia UGC-videoita, jotka on räätälöity juuri sinun alallesi – ja mittareillesi.' }
        }
    },
    {
        icon: <MonitorIcon className="size-5 text-violet-300" />,
        text: {
            en: { title: 'Agencies', desc: 'Deliver scroll-stopping creatives at scale. AI handles voice, script, and visuals - you take the credit.' },
            fi: { title: 'Toimistot', desc: 'Toimita pysäyttäviä luovia ratkaisuja mittakaavassa. Tekoäly hoitaa äänen, käsikirjoituksen ja visuaalit – sinä saat kunnian.' }
        }
    },
    {
        icon: <StoreIcon className="size-5 text-violet-300" />,
        text: {
            en: { title: 'Marketplace Sellers', desc: 'Stand out on Amazon, Etsy & eBay with videos that explain, sell, and boost CTRs.' },
            fi: { title: 'Markkinapaikkamyyjät', desc: 'Erotu Amazonissa, Etsyssä ja eBayssa videoilla, jotka selittävät, myyvät ja nostavat CTR:ää.' }
        }
    }
];
...
export const featureProofData = {
    en: {
        ...
        notifications: [
            { id: 1, title: 'Shopify', message: 'Uusi tilaus: 1 tuote 76,70 $', time: '5m sitten' },
            { id: 2, title: 'Shopify', message: 'Uusi tilaus: 1 tuote 55,87 $', time: '1m sitten' },
            { id: 3, title: 'Shopify', message: 'Uusi tilaus: 1 tuote 112,90 $', time: '2m sitten' },
            { id: 4, title: 'Shopify', message: 'Uusi tilaus: 1 tuote 64,15 $', time: '3m sitten' },
        ],
        stats: [
...
export const featuresData = [
    {
        ...
        text: {
            en: { title: 'Easy Upload', desc: 'Simply drag and drop your media—we automatically optimize every file for the best size and format.' },
            fi: { title: 'Helppo lataus', desc: 'Vedä ja pudota mediasi – optimoimme automaattisesti jokaisen tiedoston parhaaseen kokoon ja muotoon.' }
        }
    },
    {
        icon: <ZapIcon className="w-6 h-6" />,
        text: {
            en: { title: 'Fast Generation', desc: 'Create high-quality outputs in seconds with a workflow built for speed, consistency, and reliability.' },
            fi: { title: 'Nopea generointi', desc: 'Luo korkealaatuisia tuloksia sekunneissa nopeaan, johdonmukaiseen ja luotettavaan työnkulkuun rakennetulla järjestelmällä.' }
        }
    },
    {
        icon: <VideoIcon className="w-6 h-6" />,
        text: {
            en: { title: 'Video Creation', desc: 'Turn product shots into engaging, social-ready videos that feel natural and on-brand.' },
            fi: { title: 'Videon luonti', desc: 'Muuta tuotekuvista mukaansatempaavia, somevalmiita videoita, jotka tuntuvat luonnollisilta ja brändisi mukaisilta.' }
        }
    }
];
...
export const faqData = {
    en: [
    ...
    fi: [
        {
            ...
            answer: 'Tekoälymme käyttää kehittyneitä malleja, jotka on koulutettu miljoonilla tuote- ja UGC-mainoksilla, luodakseen välittömästi korkeasti konvertoivia videoita kuvistasi – ei editointia tai suunnittelutaitoja.'
        },
        {
            question: 'Omistanko tuottamani sisällön?',
            answer: 'Ehdottomasti! Kaikki luomasi videot ja kuvat ovat sinun käytettäväksi mainoksissa, verkkokaupassa, somessa ja muualla.'
        },
        {
            question: 'Voinko peruuttaa tilaukseni milloin tahansa?',
            answer: 'Kyllä, voit peruuttaa milloin tahansa hallintapaneelista. Krediittisi ovat käytettävissä laskutuskauden loppuun.'
        },
        {
            question: 'Mitä tiedostomuotoja tuetaan?',
            answer: 'Voit ladata JPG-, PNG- tai WEBP-kuvia. Tulosteet ovat korkearesoluutioisia PNG-kuvia ja MP4-videoita, jotka on optimoitu kaikille suurille somealustoille.'
        },
        {
            question: 'Kuinka nopeasti saan tulokset?',
            answer: 'Useimmat videot ovat valmiita alle 60 sekunnissa. Ultra-tilaajat saavat nopeimmat ajat ja Full HD -laadun.'
        }
    ]
};
...
export const footerLinks = [
    ...
    },
    {
        ...
        links: [
            { name: { en: "LinkedIn", fi: "LinkedIn" }, url: 'https://www.linkedin.com/in/kai-nguyen-08390236b/' },
            { name: { en: "GitHub", fi: "GitHub" }, url: 'https://github.com/trungnguyen1221999' }
        ]
    }
];