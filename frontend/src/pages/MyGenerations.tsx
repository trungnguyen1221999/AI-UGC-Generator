...
const filterClass =
  "rounded-xl bg-white/10 border border-white/15 px-4 py-2 text-white text-sm font-medium focus:outline-none focus:border-violet-400 transition appearance-none";
        ...
        <div className="w-full shadow-xl">
          ...
          {!loading && generations.length === 0 && (
            <div className="flex flex-col items-center justify-center gap-6 mt-10">
              <Title title={t.emptyTitle} description={t.emptyDesc} />
