...
export default function Generator() {
  ...
  const inputClass =
    "rounded-xl bg-white/10 border border-white/10 px-4 py-2 text-white focus:outline-none focus:border-violet-400 transition text-base font-medium";
    ...
    return (
      <div className="min-h-screen flex flex-col items-center justify-center">
        <Title
          ...
          description={
            t.signInDescription ||
            "Please sign in to continue using the generator."
          }
        />
      ...
      <div className="app-container max-md:w-screen flex items-center justify-center">
        ...
        >
          ...
          >
              ...
              <div className="flex flex-col justify-center gap-6">
                ...
                <label className={labelClass}>
                  <span className={labelTextClass}>
                    ...
                    <span className="heading-color">(optional)</span>
                  </span>
                  <textarea
            ...
            {/* Generate button */}
            <div
              className={`flex justify-center mt-10${isGenerating ? " cursor-not-allowed" : ""}`}
            >
              <GenerateButton
                isGenerating={isGenerating}
                label={t.generate}
                generatingLabel={
                  t.generatingFriendly ||
