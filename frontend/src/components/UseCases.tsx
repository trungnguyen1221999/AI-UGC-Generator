    ...
    <section className="py-20 2xl:py-32">
      <div className="app-container">
        <Title
          ...
          heading={
            language === "fi"
              ? "Kenelle? Kaikille, jotka myyvät verkossa."
              : "Who's It For? Everyone Who Sells Online."
          }
          description={
            language === "fi"
              ? "Yksinyrittäjistä 8-numeroisiin brändeihin – jos teet mainontaa, CreateUGC säästää aikaa ja kasvattaa ROI:ta."
              : "From solopreneurs to 8-figure brands — if you're running ads, CreateUGC saves time and boosts ROI."
          }
        />
