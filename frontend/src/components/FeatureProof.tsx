  ...
  return (
    <section className="py-10 md:py-15">
      <div className="app-container">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center mt-10 md:mt-15 md:mb-16">
          {/* Left: text */}
          <motion.div
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 divide-y sm:divide-y-0 sm:divide-x divide-white/10 border-t border-white/10 md:pt-10">
          {data.stats.map(
            (stat: { value: string; label: string }, i: number) => (
              ...
              >
                <span className="text-5xl font-bold heading-color leading-none shrink-0">
                  {stat.value}
                </span>
                <span className="text-white text-xl md:text-2xl leading-snug">
                  {stat.label}
                </span>
              </motion.div>
            ),
