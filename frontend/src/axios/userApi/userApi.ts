...
export const getAllUserProjects = (params?: any) =>
  axios.get("/api/users/projects", { params });

// Get project by id
export const getProjectById = (id: string) =>
  axios.get(`/api/users/projects/${id}`);

// Toggle publish/unpublish project
export const toggleProjectPublish = (id: string) =>
  axios.patch(`/api/users/projects/${id}/toggle-publish`);
