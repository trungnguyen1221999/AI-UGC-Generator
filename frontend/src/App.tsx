      ...
      <LanguageProvider>
        <BrowserRouter>
          ...
          <Routes>
            ...
            <Route path="/my-generations" element={<MainLayout><MyGenerations /></MainLayout>} />
            <Route path="/plan" element={<MainLayout><Plan /></MainLayout>} />

            {/* ── Dashboard layout routes — Sidebar only, no Navbar/Footer ── */}
            <Route path="/dashboard" element={<DashboardLayout />}>
              <Route index element={<div className="text-white/50 p-8">Select a page from the sidebar.</div>} />
